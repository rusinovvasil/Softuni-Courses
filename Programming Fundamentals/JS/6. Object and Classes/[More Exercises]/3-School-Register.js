function getSchoolGrades(array) {
    ...
    while (array.length !== 0) {
        let [, student, grade, annualGrade] = regex.exec(array.shift());
        grade = Number(grade);
    ...
    for (let [key, value] of Object.entries(schoolRegister)) {
        ...
        console.log(`Average annual score from last year: ${value.avgAnnualGrade.toFixed(2)}`);
        console.log(``);
    }
}
